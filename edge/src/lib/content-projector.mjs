...
const BOOK_TAGS_ES = {
  ...
  desire: "deseo",
  devops: "devops",
  "diaries-and-letters": "diarios-y-cartas",
  ...
  graphs: "grafos",
  grief: "duelo",
  hauntology: "hauntología",
  history: "historia",
  "hiv-aids": "vih-sida",
  holocaust: "holocausto",
  hope: "esperanza",
  housing: "vivienda",
  "human-flourishing": "florecimiento-humano",
  humor: "humor",
  identity: "identidad",
  inclusion: "inclusión",
  india: "india",
  ...
  "internet-culture": "cultura-de-internet",
  ...
  poetry: "poesía",
  politics: "política",
  posthumanism: "poshumanismo",
  poverty: "pobreza",
  power: "poder",
  precarity: "precariedad",
  privacy: "privacidad",
  ...
  rhetoric: "retórica",
  science: "ciencia",
  "science-and-technology-studies": "estudios-de-ciencia-y-tecnología",
  "search-engines": "motores-de-búsqueda",
  "self-help-critique": "crítica-a-la-autoayuda",
